...
if(isset($_REQUEST['eid']) && !empty($_REQUEST['eid'])) {
	$query .= " WHERE `id` = '" . mysql_real_escape_string($_REQUEST['eid']) . "'";
} else if(isset($_REQUEST['diff']) && !empty($_REQUEST['diff'])) {
	$query .= " WHERE `diff` = '" . mysql_real_escape_string($_REQUEST['diff']) . "'";
} else if(isset($_REQUEST['old_id']) && !empty($_REQUEST['old_id'])) {
	$query .= " WHERE `old_id` = '" . mysql_real_escape_string($_REQUEST['old_id']) . "'";
} else if(isset($_REQUEST['new_id']) && !empty($_REQUEST['new_id'])) {
	$query .= " WHERE `new_id` = '" . mysql_real_escape_string($_REQUEST['new_id']) . "'";
} else {
	$data = array(
